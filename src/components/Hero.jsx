      ...
      <div className="max-w-6xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="font-syne font-extrabold leading-[1.0] tracking-tight text-[clamp(3rem,6.5vw,5.5rem)] animate-fade-up delay-100">
              Frontend<br />
          ...
          <div className="flex justify-center animate-float">
            <div className="relative w-72 md:w-80 lg:w-[340px]">
              ...
              >
                ...
                <p className="font-syne text-xs font-bold uppercase tracking-[0.15em] text-[#FF4D00]/50 group-hover:text-[#FF4D00]/80 transition-colors">
                  Your Photo Here
                </p>
                <p className="text-[10px] text-[#333] font-syne uppercase tracking-widest">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -right-4 bg-[#FFD600] text-black font-syne font-extrabold text-xs px-4 py-2 rounded-full shadow-xl">
                React Specialist ⚡
              </div>
            </div>
          </div>
